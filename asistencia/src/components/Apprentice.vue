...
const columns = ref([
  {
    name: "ficha", headerStyle: 'font-size: 18px; font-weight: bold; color: #3a9a42; background-color: #f5f5f5; text-align: center;',
  ...
  {
    name: "documento", headerStyle: 'font-size: 18px; font-weight: bold; color: #3a9a42; background-color: #f5f5f5; text-align: center;',
  style:"font-size:16px",
    align: "center",
    label: "Documento",
    field: "cc",
  ...
  {
    name: "nombre", headerStyle: 'font-size: 18px; font-weight: bold; color: #3a9a42; background-color: #f5f5f5; text-align: center;',
  style:"font-size:16px",
    align: "center",
    label: "Nombre del aprendiz",
    field: "nombre",
  ...
  {
    name: "email", headerStyle: 'font-size: 18px; font-weight: bold; color: #3a9a42; background-color: #f5f5f5; text-align: center;',
  style:"font-size:16px",
    align: "center",
    label: "Email",
    field: "email",
  ...
  {
    name: "telefono", headerStyle: 'font-size: 18px; font-weight: bold; color: #3a9a42; background-color: #f5f5f5; text-align: center;',
  style:"font-size:16px",
    align: "center",
    label: "Teléfono",
    field: "telefono",
  ...
  {
    name: "firma", headerStyle: 'font-size: 18px; font-weight: bold; color: #3a9a42; background-color: #f5f5f5; text-align: center;',
  style:"font-size:16px",
    align: "center",
    label: "Firma",
    field: "firma",
  ...
  {
    name: "estado1", headerStyle: 'font-size: 18px; font-weight: bold; color: #3a9a42; background-color: #f5f5f5; text-align: center;',
  style:"font-size:16px",
    align: "center",
    label: "Estado",
    field: "estado",
